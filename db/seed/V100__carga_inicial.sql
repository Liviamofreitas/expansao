...
VALUES
    ('OPE.RELATORIO_MEDICAO', 'Relatório técnico de medição / atividades', 'Operação e medição', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Operação', NULL, 'carga-inicial-anexo1'),
    ('OPE.PLANILHA_MEDICAO', 'Planilha de faturamento (memória de cálculo)', 'Operação e medição', 'CONTRATO', 'MENSAL', 'M', '["pdf", "xlsx"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Operação', NULL, 'carga-inicial-anexo1'),
    ('OPE.AUTORIZACAO_FATURAMENTO', 'Autorização formal de faturamento', 'Operação e medição', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Operação', NULL, 'carga-inicial-anexo1'),
    ('OPE.ATESTE_RECEBIMENTO', 'Ateste / Termo de recebimento do cliente', 'Operação e medição', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Cliente', NULL, 'carga-inicial-anexo1'),
    ('OPE.EMPENHO', 'Nota de empenho vigente', 'Operação e medição', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Cliente', NULL, 'carga-inicial-anexo1'),
    ('OPE.RELACAO_ALOCADOS', 'Relação de empregados alocados no contrato', 'Operação e medição', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Operação', NULL, 'carga-inicial-anexo1'),
    ('OPE.DOC_TECNICA', 'Documentação técnica dos sistemas desenvolvidos', 'Operação e medição', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'NAO_BLOQUEANTE', 'PUBLICO_CLIENTE', 'Operação', NULL, 'carga-inicial-anexo1'),
    ('OPE.FOLHA_PONTO', 'Folha de ponto / ponto eletrônico', 'Operação e medição', 'PROFISSIONAL', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('OPE.MOVIMENTACAO_PESSOAL', 'Movimentação de pessoal do contrato', 'Operação e medição', 'CONTRATO', 'EVENTUAL', 'M', '["pdf"]'::jsonb, 'NAO_BLOQUEANTE', 'PUBLICO_CLIENTE', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FIS.NOTA_FISCAL', 'Nota fiscal de serviço', 'Fiscal', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('FIS.NF_XML', 'XML da nota fiscal', 'Fiscal', 'CONTRATO', 'MENSAL', 'M', '["xml"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('FIS.CARTA_ENTREGA_NF', 'Carta de entrega da nota fiscal', 'Fiscal', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('CER.CND_RFB', 'CND Receita Federal / Dívida Ativa da União', 'Certidões e regularidade', 'CORPORATIVO', 'MENSAL', 'VIGENCIA_NF', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('CER.CRF_FGTS', 'Certificado de Regularidade do FGTS (CRF)', 'Certidões e regularidade', 'CORPORATIVO', 'MENSAL', 'VIGENCIA_NF', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('CER.CNDT', 'Certidão Negativa de Débitos Trabalhistas (CNDT)', 'Certidões e regularidade', 'CORPORATIVO', 'MENSAL', 'VIGENCIA_NF', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('CER.SICAF', 'Consulta SICAF', 'Certidões e regularidade', 'CORPORATIVO', 'MENSAL', 'VIGENCIA_NF', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('CER.CND_ESTADUAL', 'Certidão de regularidade fiscal estadual/distrital', 'Certidões e regularidade', 'CORPORATIVO', 'MENSAL', 'VIGENCIA_NF', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('CER.CND_CIVEL_CRIMINAL', 'Certidão negativa de distribuição cível e criminal', 'Certidões e regularidade', 'CORPORATIVO', 'MENSAL', 'VIGENCIA_NF', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('CER.CND_FALENCIA', 'Certidão negativa de falência e recuperação judicial', 'Certidões e regularidade', 'CORPORATIVO', 'MENSAL', 'VIGENCIA_NF', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PUBLICO_CLIENTE', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('FOL.FOPAG', 'Folha de pagamento analítica', 'Folha', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FOL.COMPROVANTE_PG', 'Comprovante de pagamento da folha', 'Folha', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('FOL.CONTRACHEQUE', 'Contracheque / recibo de pagamento', 'Folha', 'PROFISSIONAL', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('DEC.FOPAG_13', 'Folha de pagamento do 13º salário', '13º salário', 'CONTRATO', '13O', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('DEC.COMPROVANTE_PG_13', 'Comprovante de pagamento do 13º salário', '13º salário', 'CONTRATO', '13O', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('FGT.GUIA', 'Guia FGTS Digital', 'FGTS', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FGT.COMPROVANTE_PG', 'Comprovante de pagamento do FGTS', 'FGTS', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('FGT.EXTRATO', 'Extrato analítico do FGTS por trabalhador', 'FGTS', 'PROFISSIONAL', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FGT.RELATORIO_DIGITAL', 'Relatórios do FGTS Digital (individualização)', 'FGTS', 'PROFISSIONAL', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FGT.GUIA_RESCISORIA', 'Guia FGTS rescisória (GRRF)', 'FGTS', 'PROFISSIONAL', 'RESCISAO', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FGT.COMPROVANTE_PG_GRRF', 'Comprovante de pagamento da GRRF', 'FGTS', 'PROFISSIONAL', 'RESCISAO', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('INS.DCTFWEB', 'DCTFWeb completa', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'DP', NULL, 'carga-inicial-anexo1'),
    ('INS.DARF', 'DARF de recolhimento (DCTFWeb)', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'DP', NULL, 'carga-inicial-anexo1'),
    ('INS.COMPROVANTE_PG', 'Comprovante de pagamento do INSS', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('INS.COMPROVANTE_PG_IRRF', 'Comprovante de pagamento do IRRF', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('INS.PARCELAMENTO_TABELA', 'Tabela resumo dos parcelamentos INSS', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'NAO_BLOQUEANTE', 'INTERNO', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('INS.PARCELAMENTO_COMPROV', 'DARF e comprovante dos parcelamentos INSS', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('BEN.RELACAO_PLANO_SAUDE', 'Relação de beneficiários do plano de saúde', 'Benefícios', 'PROFISSIONAL', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL_SENSIVEL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('BEN.COMPROVANTE_PLANO_SAUDE', 'Comprovante de pagamento do plano de saúde', 'Benefícios', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL_SENSIVEL', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('BEN.RELACAO_VA_VR', 'Relação de vale-alimentação/refeição', 'Benefícios', 'PROFISSIONAL', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('BEN.COMPROVANTE_VA_VR', 'Comprovante de pagamento do VA/VR', 'Benefícios', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('BEN.RELACAO_VT', 'Relação de vale-transporte', 'Benefícios', 'PROFISSIONAL', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', 'VT_ADESAO', 'carga-inicial-anexo1'),
    ('BEN.COMPROVANTE_VT', 'Comprovante de pagamento do VT', 'Benefícios', 'CONTRATO', 'MENSAL', 'M', '["pdf"]'::jsonb, 'BLOQUEANTE', 'INTERNO', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('BEN.TERMO_NAO_ADESAO_VT', 'Termo de não adesão ao VT', 'Benefícios', 'PROFISSIONAL', 'EVENTUAL', 'EVENTO', '["pdf"]'::jsonb, 'NAO_BLOQUEANTE', 'PESSOAL', 'DP', 'VT_ADESAO', 'carga-inicial-anexo1'),
    ('FER.AVISO', 'Aviso de férias', 'Férias', 'PROFISSIONAL', 'FERIAS', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FER.RECIBO', 'Recibo de férias', 'Férias', 'PROFISSIONAL', 'FERIAS', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('FER.COMPROVANTE_PG', 'Comprovante de pagamento de férias', 'Férias', 'PROFISSIONAL', 'FERIAS', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('RES.AVISO_PREVIO', 'Aviso prévio', 'Rescisão', 'PROFISSIONAL', 'RESCISAO', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('RES.TRCT', 'TRCT / Termo de rescisão', 'Rescisão', 'PROFISSIONAL', 'RESCISAO', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('RES.ASO_DEMISSIONAL', 'ASO demissional', 'Rescisão', 'PROFISSIONAL', 'RESCISAO', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL_SENSIVEL', 'DP', NULL, 'carga-inicial-anexo1'),
    ('RES.COMPROVANTE_PG', 'Comprovante de pagamento da rescisão', 'Rescisão', 'PROFISSIONAL', 'RESCISAO', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'Financeiro', NULL, 'carga-inicial-anexo1'),
    ('ADM.DOCUMENTACAO', 'Documentação admissional', 'Admissão', 'PROFISSIONAL', 'ADMISSAO', 'EVENTO', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL_SENSIVEL', 'DP', NULL, 'carga-inicial-anexo1')
ON CONFLICT (codigo) DO NOTHING;
