...
VALUES
    ...
    ('INS.DCTFWEB', 'DCTFWeb completa', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'DP', NULL, 'OWNCLOUD', '[]'::jsonb, 'carga-inicial-anexo1'),
    ...
    ('INS.COMPROVANTE_PG', 'Comprovante de pagamento do INSS', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'Financeiro', NULL, 'OWNCLOUD', '[]'::jsonb, 'carga-inicial-anexo1'),
    ('INS.COMPROVANTE_PG_IRRF', 'Comprovante de pagamento do IRRF', 'INSS e tributos', 'CORPORATIVO', 'MENSAL', 'M_MENOS_1', '["pdf"]'::jsonb, 'BLOQUEANTE', 'PESSOAL', 'Financeiro', NULL, 'OWNCLOUD', '[]'::jsonb, 'carga-inicial-anexo1'),
